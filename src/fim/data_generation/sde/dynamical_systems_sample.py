...
def get_dynamicals_system_data_from_yaml(yaml_file: str, label: str) -> List[DynamicalSystem | FIMSDEDatabatch]:
    """
    ...
    # generate the data
    systems_data: List[DynamicalSystem, FIMSDEDatabatch] = []
