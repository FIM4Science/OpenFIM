...
This section provides a theoretical foundation for understanding Stochastic Differential Equations (SDEs) and introduces the concepts needed for the practical tutorial. This content is adapted from Appendix B of the corresponding publication {cite}`fim_sde`.
