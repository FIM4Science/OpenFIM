...
base="python3 scripts/sde/latent_sde_train_on_real_world_cross_validation.py --base-config=configs/train/sde/20250726_latent_sde_real_world_setup.yaml \
    --seed=0 \
    --exp-name=latent_sde_latent_dim_4_context_dim_100_decoder_NLL_train_subsplits_100 \
    --mse-objective=False \
    --num-train-subsplits=100 \
    --save-every=500 \
    --epochs=5000 \
