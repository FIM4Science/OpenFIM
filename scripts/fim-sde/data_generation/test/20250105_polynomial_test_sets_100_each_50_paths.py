...
from fim.data.data_generation.dynamical_systems import Degree2Polynomial, Polynomials
...
def up_to_deg_polys(drift: int, diffusion: int, std_normal_init: bool, state_dim: int) -> tuple[Degree2Polynomial, dict]:
    ...
    process_hyperparameters = {
        ...
        "state_dim": state_dim,
        "max_degree_drift": drift,
        "max_degree_diffusion": diffusion,
        "drift_params": {
            "degree_survival_rate": 0.5,
            "max_degree_survives": True,
            "monomials_survival_distribution": {"name": "uniform", "min": 0.25, "max": 0.75},
    ...
    return Polynomials(process_hyperparameters), process_hyperparameters
...
if __name__ == "__main__":
    ...
    for poly_sys in polynomial_systems:
        ...
        save_dir = Path(data_path) / "processed" / "test" / "20250105_polynomial_test_sets_100_each_50_paths" / name
