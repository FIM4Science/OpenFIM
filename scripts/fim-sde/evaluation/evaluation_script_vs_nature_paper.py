...
if __name__ == "__main__":
    ...
    benchmarks = [
        Benchmark(
            GroundTruth = ModelResults("GroundTruth", Path("/cephfs_projects/foundation_models/data/SDE/evaluation/20250129_coarse_synthetic_systems_5000_points_data/ksig_reference_paths.json")),
