...
if __name__ == "__main__":
    ...
    datasets = ['Damped Linear', 'Damped Cubic', 'Duffing', 'Glycosis', 'Hopf', 'Double Well', 'Wang', 'Syn Drift']
    models = ["FIM", "BISDE", "SparseGP"]
    
    with open("evaluations/final_table.txt", "w") as f:
        f.write("\\begin{tabular}{llllllllll}\n")
        f.write("$\\tau$ & Model & Damped Linear & Damped Cubic & Duffing & Glycolysis & Hopf & Double Well & Wang & Syn Drift\\\\\n")
        f.write("\hline\n")
