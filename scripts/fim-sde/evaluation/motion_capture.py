...
def get_mocap_dataloaders_inits(mocap_dir: Optional[Path] = None) -> tuple[dict]:
    ...
    dataloader_dict = {
        # "forecasting_20_perc_all_paths": _get_dataloader("forecasting_0.2_perc/all_paths_one_element"),
        # "forecasting_20_perc_single_path": _get_dataloader("forecasting_0.2_perc/single_path_per_element"),
    ...
    dataloader_display_ids = {
        # "forecasting_20_perc_all_paths": "All Paths Input, 20% forecast",
        # "forecasting_20_perc_single_path": "Single Path Input, 20% forecast",
