...
if __name__ == "__main__":
    ...
    benchmarks = [
        Benchmark(
            GroundTruth=ModelResults(
                "GroundTruth",
                Path("/cephfs_projects/foundation_models/data/SDE/evaluation/20250130_bisde_real_world_oil_wind/ksig_reference_paths.json"),
            ),
            FIM=ModelResults(
                "FIM", Path("/cephfs_projects/foundation_models/data/SDE/evaluation/20250130_bisde_real_world_oil_wind/model_paths.json")
            ),
