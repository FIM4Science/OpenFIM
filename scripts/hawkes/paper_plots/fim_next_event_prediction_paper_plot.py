            ...
            if num_inference_sequences == 0:
                ...
                try:
                    ...
                    if original_length <= 1:
                        ...
                        ax.set_title("FIM-PP (fine-tuned) Taxi Dataset Next Event Prediction", fontsize=22)
                        ...
                        legend1 = ax.legend(handles=color_handles, loc="upper right", fontsize=18)
