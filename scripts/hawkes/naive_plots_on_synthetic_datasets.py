...
EXPERIMENT_DIR = Path(
    ...
    "/cephfs/users/berghaus/FoundationModels/FIM/results/FIM_Hawkes_1st_exp_rmse_no_norm_2000_paths_mixed_250_events_mixed-experiment-seed-10-dataset-dataset_kwargs-field_name_for_dimension_grouping-base_intensities_04-09-2102/checkpoints/best-model"
)
num_samples = 5
start_idx = 0
SEQ_LEN = 250
