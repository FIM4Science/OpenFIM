...
def main():
    ...
    parser.add_argument("--pretrained-dir", default=str(FIMODE_DIR / "pretrained"),
                        help="Local copy of HF pretrained weights (falls back to HF download)")
    parser.add_argument("--device", default="cuda")
    parser.add_argument("--zeroshot", action="store_true",
                        help="Also evaluate zero-shot baseline")
