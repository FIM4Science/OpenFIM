...
if __name__ == "__main__":
    ...
    finetuned_model = load_odeon_model_from_checkpoint(Path("models/vdp2/vdp2_01-29-0223/checkpoints"), epoch=None)
    ...
    fig.tight_layout()
    plt.savefig("experiments/vdp2/vdp2_comparison.pdf", bbox_inches="tight")
    plt.close()
