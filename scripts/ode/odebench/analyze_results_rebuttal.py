...
polynomial_indices = [
    1, 2, 3, 5, 6, 8, 9, 11, 12, 16, 17, 24, 25, 26, 27, 29, 30, 31, 37, 38, 39, 40, 41, 45, 49, 50, 52, 54, 55, 56, 57, 58, 59, 60, 61, 63
]
# this one contains 9/10 3D systems and 15/28 2D systems and 11/23 1D systems
# 31.4% are 1D, 42.9% are 2D, 25.7% are 3D

non_polynomial_indices = [
    4, 7, 10, 13, 14, 15, 18, 19, 20, 21, 22, 23, 28, 32, 33, 34, 35, 36, 42, 43, 44, 46, 47, 48, 51, 53, 62
]
