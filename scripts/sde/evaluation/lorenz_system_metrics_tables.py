...
if __name__ == "__main__":
    ...
    #
    # evaluation_base_path = Path("/cephfs_projects/foundation_models/data/SDE/saved_evaluation_results/20250808_not_used_in_neurips_rebuttal/lorenz_system_vf_and_paths_evaluation/lorenz_system_vf_and_paths_evaluation")
    # rebuttal_base_path = Path("/cephfs_projects/foundation_models/data/SDE/saved_evaluation_results/20250808_neurips_rebuttal_evaluations/lorenz_system_vf_and_paths_evaluation/")
