...
if __name__ == "__main__":
    ...
    experiment_descr = "finetune_sampling_nll_neurips_rebuttal_1_step_ahead_1_em_step_512_points_and_latent_sde_10_train_splits"
    ...
    models_order = list(models_jsons.keys())
