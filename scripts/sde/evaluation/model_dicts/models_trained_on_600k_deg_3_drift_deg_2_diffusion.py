...
def get_model_dicts_ablation_models() -> tuple[dict, dict, str]:
    ...
    model_dicts = {
        ...
        # },
        "ablation_600k_train_size_500k_steps_from_ICML_model_epoch_70": {  # TRAINED ON DELTA TAU; DON'T USE
            "checkpoint_dir": "/home/seifner/repos/FIM/saved_results/20250124_20M_params_trained_on_600k_deg_3/600k_drift_deg_3_diff_deg_2_mse_no_div_by_diff_softplus_2_layer_enc_8_layer_dec_01-21-1106_trained_longer/checkpoints/",
            "checkpoint_name": "epoch-70",
        },
    }
    models_display_ids = {
...
def get_model_dicts_600k_fixed_linear_attn() -> tuple[dict, dict, str]:
    ...
    model_dicts = {
        ...
        "20M_params_600k_polys_delta_tau_fixed_attn_fixed_softmax (checkpoint 05-06-2300)": "/home/seifner/repos/FIM/saved_results/20250430_20M_params_trained_on_600k_deg_3_with_delta_tau_fixed_linear_attn/600k_drift_deg_3_diff_deg_2_delta_tau_fixed_linear_attn_softmax_no_extra_normalization_and_fix_in_residual_layer_05-06-2300/checkpoints/",
        "20M_params_600k_polys_delta_tau_fixed_attn_fixed_softmax (checkpoint 05-10-0015)": "/home/seifner/repos/FIM/saved_results/20250430_20M_params_trained_on_600k_deg_3_with_delta_tau_fixed_linear_attn/600k_drift_deg_3_diff_deg_2_delta_tau_fixed_linear_attn_softmax_no_extra_normalization_and_fix_in_residual_layer_05-10-0015/checkpoints/",
    }
    models_display_ids = {
...
def get_model_dicts_search_good_checkpoint() -> tuple[dict, dict, str]:
    """ """
    model_dicts = {
        # "FIM_fixed_linear_attn_epoch_040": {
        #     "checkpoint_dir": "/home/seifner/repos/FIM/saved_results/20250430_20M_params_trained_on_600k_deg_3_with_delta_tau_fixed_linear_attn/600k_drift_deg_3_diff_deg_2_delta_tau_1e-1_to_1e-3_2_layer_enc_8_layer_with_fixed_linear_attn_04-28-0941/checkpoints/",
        #     "checkpoint_name": "epoch-40",
        # },
        # "FIM_fixed_linear_attn_epoch_070_good_previous_eval": {
        #     "checkpoint_dir": "/home/seifner/repos/FIM/saved_results/20250430_20M_params_trained_on_600k_deg_3_with_delta_tau_fixed_linear_attn/600k_drift_deg_3_diff_deg_2_delta_tau_1e-1_to_1e-3_2_layer_enc_8_layer_with_fixed_linear_attn_04-28-0941/checkpoints/",
        #     "checkpoint_name": "epoch-70",
        # },
        # "FIM_fixed_linear_attn_epoch_100": {
        #     "checkpoint_dir": "/home/seifner/repos/FIM/saved_results/20250430_20M_params_trained_on_600k_deg_3_with_delta_tau_fixed_linear_attn/600k_drift_deg_3_diff_deg_2_delta_tau_1e-1_to_1e-3_2_layer_enc_8_layer_with_fixed_linear_attn_05-01-1207/checkpoints/",
        #     "checkpoint_name": "epoch-100",
        # },
        # "FIM_fixed_linear_attn_epoch_125": {
        #     "checkpoint_dir": "/home/seifner/repos/FIM/saved_results/20250430_20M_params_trained_on_600k_deg_3_with_delta_tau_fixed_linear_attn/600k_drift_deg_3_diff_deg_2_delta_tau_1e-1_to_1e-3_2_layer_enc_8_layer_with_fixed_linear_attn_05-01-1207/checkpoints/",
        #     "checkpoint_name": "epoch-125",
        # },
        # "FIM_fixed_softmax_dim_epoch_040": {
        #     "checkpoint_dir": "/home/seifner/repos/FIM/saved_results/20250430_20M_params_trained_on_600k_deg_3_with_delta_tau_fixed_linear_attn/600k_drift_deg_3_diff_deg_2_delta_tau_fixed_linear_attn_softmax_no_extra_normalization_and_fix_in_residual_layer_05-03-2033/checkpoints/",
        #     "checkpoint_name": "epoch-40",
        # },
        # "FIM_fixed_softmax_dim_epoch_070": {
        ...
        #     "checkpoint_name": "epoch-70",
        # },
        # "FIM_fixed_softmax_dim_epoch_100": {
        #     "checkpoint_dir": "/home/seifner/repos/FIM/saved_results/20250430_20M_params_trained_on_600k_deg_3_with_delta_tau_fixed_linear_attn/600k_drift_deg_3_diff_deg_2_delta_tau_fixed_linear_attn_softmax_no_extra_normalization_and_fix_in_residual_layer_05-06-2300/checkpoints/",
        #     "checkpoint_name": "epoch-100",
        # },
        # "FIM_fixed_softmax_dim_epoch_125": {
        #     "checkpoint_dir": "/home/seifner/repos/FIM/saved_results/20250430_20M_params_trained_on_600k_deg_3_with_delta_tau_fixed_linear_attn/600k_drift_deg_3_diff_deg_2_delta_tau_fixed_linear_attn_softmax_no_extra_normalization_and_fix_in_residual_layer_05-06-2300/checkpoints/",
        #     "checkpoint_name": "epoch-125",
        # },
    ...
    models_display_ids = {
        "FIM_fixed_linear_attn_epoch_040": "FIM, fixed linear Attn., Epoch 040",
        "FIM_fixed_linear_attn_epoch_070_good_previous_eval": "FIM, fixed linear Attn., Epoch 070 (Good prev. Eval.)",
        "FIM_fixed_linear_attn_epoch_100": "FIM, fixed linear Attn., Epoch 100",
        "FIM_fixed_linear_attn_epoch_125": "FIM, fixed linear Attn., Epoch 125",
        "FIM_fixed_softmax_dim_epoch_040": "FIM, fixed Softmax dim., Epoch 040",
        "FIM_fixed_softmax_dim_epoch_070": "FIM, fixed Softmax dim., Epoch 070",
        "FIM_fixed_softmax_dim_epoch_100": "FIM, fixed Softmax dim., Epoch 100",
        "FIM_fixed_softmax_dim_epoch_125": "FIM, fixed Softmax dim., Epoch 125",
