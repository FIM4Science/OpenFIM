...
def get_100k_100_paths_half_noisy(project_path: Path, data_path: Path):
    yaml_path = project_path / Path("configs/data_generation/sde/20250314_100k_drift_deg_4_diffusion_deg_2_100_paths_half_with_noise.yaml")
    save_dir = data_path / Path("100k_polynomials_drift_deg_4_diffusion_deg_2_100_paths_half_with_noise")
