...
def get_degree_surv_rate_075_monomial_surv_rate_05(project_path: Path, data_path: Path):
    yaml_path = project_path / Path(
        "configs/data_generation/sde/30k_drift_deg_3_ablation_studies/sde-drift-deg-3-diffusion-deg-0-50-paths-degree-survives-075-monomials-survive-05.yaml"
    )
...
def get_degree_surv_rate_05_monomial_surv_rate_025(project_path: Path, data_path: Path):
    yaml_path = project_path / Path(
        "configs/data_generation/sde/30k_drift_deg_3_ablation_studies/sde-drift-deg-3-diffusion-deg-0-50-paths_degree_survives-05-monomials-survive-025.yaml"
    )
...
def get_uniform_init_cond(project_path: Path, data_path: Path):
    yaml_path = project_path / Path(
        "configs/data_generation/sde/30k_drift_deg_3_ablation_studies/sde-drift-deg-3-diffusion-deg-0-50-paths-uniform-init-cond.yaml"
    )
...
def get_diffusion_degree_2(project_path: Path, data_path: Path):
    yaml_path = project_path / Path(
        "configs/data_generation/sde/30k_drift_deg_3_ablation_studies/sde-drift-deg-3-diffusion-deg-2-50-paths.yaml"
    )
...
def get_300_paths(project_path: Path, data_path: Path):
    yaml_path = project_path / Path(
        "configs/data_generation/sde/30k_drift_deg_3_ablation_studies/sde-drift-deg-3-diffusion-deg-0-300-paths.yaml"
    )
...
def get_init_cond_mean_from_uniform(project_path: Path, data_path: Path):
    yaml_path = project_path / Path(
        "configs/data_generation/sde/30k_drift_deg_3_ablation_studies/sde-drift-deg-3-diffusion-deg-0-init-cond-mean-from-uniform.yaml"
    )
...
def get_one_long_path_data(project_path: Path, data_path: Path):
    yaml_path = project_path / Path(
        "configs/data_generation/sde/30k_drift_deg_3_ablation_studies/sde-drift-deg-3-diffusion-deg-0-1-path-50-paths-length-128-equivalent.yaml"
    )
...
def get_one_degree_monomial_uniform_surivial(project_path: Path, data_path: Path):
    yaml_path = project_path / Path(
        "configs/data_generation/sde/30k_drift_deg_3_ablation_studies/sde-drift-deg-3-diffusion-deg-0-monomial-survival-uniform.yaml"
    )
...
def get_degree_4_drift_data(project_path: Path, data_path: Path):
    yaml_path = project_path / Path(
        "configs/data_generation/sde/30k_drift_deg_3_ablation_studies/sde-drift-deg-4-diffusion-deg-0-50-paths.yaml"
    )
...
def get_delta_tau_1e_1_to_1e_3(project_path: Path, data_path: Path):
    yaml_path = project_path / Path(
        "configs/data_generation/sde/30k_drift_deg_3_ablation_studies/sde-drift-deg-3-diffusion-deg-0-50-paths-delta-tau-1e-3-to-1e-1.yaml"
    )
    save_dir = data_path / Path("data/processed/train/30k_drift_deg_3_ablation_studies/delta_tau_1e-1_to_1e-3")
    labels_to_use = ["train", "test", "validation"]
    return yaml_path, labels_to_use, save_dir
...
if __name__ == "__main__":
    ...
    # tr_save_dir = Path("/home/seifner/repos/FIM/generate_dynamic_systems_tr")

    project_path = Path("/home/seifnerp_hpc/repos/FIM/")
    data_path = Path("/lustre/scratch/data/seifnerp_hpc-fim_data/")
    tr_save_dir = Path("/lustre/scratch/data/seifnerp_hpc-fim_data/generate_dynamic_systems_tr")

    # project_path = Path("/Users/patrickseifner/repos/FIM")
    # data_path = Path("/Users/patrickseifner/repos/FIM")
    # tr_save_dir = Path("/Users/patrickseifner/repos/FIM/generate_dynamic_systems_tr")
    ...
    # print("delta tau 1e-1 to 1e-3")
    # yaml_path, labels_to_use, save_dir = get_delta_tau_1e_1_to_1e_3(project_path, data_path)
