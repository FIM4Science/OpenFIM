...
def get_450k_100_paths_monomials_survive_uniformly(project_path: Path, data_path: Path):
    yaml_path = project_path / Path(
        "configs/data_generation/sde/20250110_450k_drift_deg_3_diffusion-deg-0-100-paths-monomials-survive-uniformly.yaml"
    )
...
def get_450k_100_paths_monomials_coeffs_std_10(project_path: Path, data_path: Path):
    yaml_path = project_path / Path(
        "configs/data_generation/sde/20250113_450k_drift_deg_3_diffusion_deg_0_100_paths_monomial_coefficients_std_10.yaml"
    )
