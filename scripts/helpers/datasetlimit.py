...
OUT_PATH = "/home/cvejoski/Projects/FoundationModels/FIM/data/interim/mjp/25k_hom_mjp_6_st_10s_1%_noise_rand_300-samples-per-intensity_with_initial_distribution/train"
...
for file in Path(PATH).rglob("*.pt"):
    with open(file, "rb") as f:
        ...
        # data = pickle.load(f)
        data = torch.load(f)
        B = 1  # Set the limit for the first dimension
        # limited_data = {}
